...
<!DOCTYPE html>
	...
	<div class="container-fluid">
		...
		<c:if test="${user.permission == true}">
			<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box" onclick="add()">
				<figure>
					<a><img src="images/AddQuestion.png" alt="Image" class="img-responsive"></a>
				</figure>
				<span class="fh5co-meta"><a>${user.name }</a></span>
				<h2 class="fh5co-article-title"><a>添加照片</a></h2>
				<span class="fh5co-meta fh5co-date">${date }</span>
			</article>
		</c:if>
			<c:forEach items="${listPicture }" var="p">
				
			<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>
					<a href="${pageContext.request.contextPath }/picture.action?id=${p.id}"><img src="${p.src_image }" alt="Image" class="img-responsive"></a>
				</figure>
				<span class="fh5co-meta"><a name="${p.id }" onclick="collection(this)" style="cursor: pointer;">${p.isCollection }</a></span>
				<h2 class="fh5co-article-title"><a href="${pageContext.request.contextPath }/picture.action?id=${p.id}">录入时间</a></h2>
	...
	<!-- 添加图片位置 -->
	<input id="addPicture" type="file" style="display: none;" accept="image/jpeg" onchange="Submit()">
